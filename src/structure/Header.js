	...
	return(
		...
		<header className='w-full h-24 bg-white border-b-2 border-black flex justify-between items-center hover:bg-gray-200 transition duration-300 ease-in'>
			...
			<div className='flex justify-center items-center'>
				<a className=''>
					<button className='h-6 px-5 py-2 mt-3 mx-1 text-xl rounded-xl bg-blue-400 border-b-4 border-white hover:bg-blue-200 hover:border-blue-400 transition duration-300 ease-in flex justify-center items-center'>Sign in</button>
				</a>

				<svg className='m-s mx-5 hover:cursor-pointer hover:text-blue-400 transition duration-300 ease-in' xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 16 16">
